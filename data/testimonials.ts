...
// Utility: duplicate testimonials for looping carousels (keeps mapping logic out of components/pages).
export function repeatTestimonials(items: Testimonial[], times: number) {
