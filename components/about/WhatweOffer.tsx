            ...
            <div className="grid grid-cols-4 gap-5">
                <div className="p-5 rounded-2lg bg-[#F2EFEA] flex flex-col gap-4">
                    ...
                    <div className="">
                        ...
                        <p className="text-base">From hidden gems to world-famous landmarks, we curate destinations that excite and inspire.</p>
                    </div>
                </div>
                <div className="p-5 rounded-2lg bg-[#F2EFEA] flex flex-col gap-4">
                    <div className="relative overflow-hidden rounded-2lg">
                    ...
                    <div className="">
                        ...
                        <p className="text-base">Every trip is as unique as you are—whether it’s a family vacation, a solo retreat, or an eco-friendly escape.</p>
                    </div>
                </div>
                <div className="p-5 rounded-2lg bg-[#F2EFEA] flex flex-col gap-4">
                    <div className="relative overflow-hidden rounded-2lg">
                    ...
                    <div className="">
                        ...
                        <p className="text-base">Leave the logistics to us—flights, hotels, visas, and more—so you can focus on enjoying your trip.</p>
                    </div>
                </div>
                <div className="p-5 rounded-2lg bg-[#F2EFEA] flex flex-col gap-4">
                    <div className="relative overflow-hidden rounded-2lg">
                    ...
                    <div className="">
                        ...
                        <p className="text-base">We design itineraries that support local economies, reduce environmental impact, and celebrate cultural heritage.
</p>
                    </div>
                </div>
            </div>
