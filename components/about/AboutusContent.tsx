            ...
            <div className="container max-w-[1330px] relative z-1">
                <div className="row">
                  ...
                  Welcome to Buy My Fare{" "}
                                ...
                                <p className="mt-5">
                                    {" "}
                                    At Buy My Fare, we believe that travel is more
                                    than just a journey; it’s a collection of
                                    moments, stories, and connections that shape
                                    who we are. Our passion lies in creating travel
                                    experiences that resonate with your heart and
                                ...
                                <div className="mt-5 bg-[#F2EFEA] relative overflow-hidden rounded-2xl flex flex-wrap items-center p-5">
                                    <div className="text-center relative">
                                        <span className="block font-title font-normal text-lg mb-5">
                                            Motivated by this vision, I pursued a degree in <strong>Sustainable Tourism Management</strong>, where I learned how to grow tourism in a way that benefits local communities, protects the environment, and ensures a meaningful experience for travelers. I wanted to create a travel agency that doesn’t just plan trips but also promotes <strong>responsible tourism</strong>, helps eliminate the negative impacts of mass tourism, and empowers travelers to make a positive difference during their journeys. </span>
                                    </div>
                                </div>
                                <p className="mt-5">
                                    {" "}
                                    With this foundation, <strong>Buy My Fare</strong> was created to make travel not only hassle-free but also purposeful. We aim to educate travelers about how their choices can support local cultures, protect natural wonders, and ensure that future generations can enjoy these treasures as much as we do.{" "}
                                </p>
                            </div>
                        </div>
                    </div>
