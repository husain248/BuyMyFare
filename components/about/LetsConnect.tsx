    ...
    <section>
        ...
        <div className="container-full">
            ...
            <div className="relative overflow-hidden">
                ...
                <p className="text-white">Travel isn’t just about where you go; it’s about what you take back with you. At Buy My Fare, we’re here to help you start that journey—with a promise to make it extraordinary, responsible, and stress-free. So, pack your bags, and let the memories begin.”
                ...
                <img src="/assets/images/about/large/img4.png" alt="" className="size-full min-h-75 object-cover" data-speed="0.7" />
            </div>
