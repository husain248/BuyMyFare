        ...
        <div className="container-full">
            ...
            <div className="relative overflow-hidden">
                ...
                <h1 className="2xxl:text-10xxl xl:text-10xl sm:text-8xl text-5xl mb-2.5 text-[#ffffff] font-bold headline">
                    Why We Do What We Do</h1>
                <p className="text-white">Buy My Fare isn’t just a business—it’s a passion project built on the belief that travel should be accessible, responsible, and deeply personal. We understand the thrill of exploring new horizons and the challenges that come with it. That’s why we’ve made it our mission to create seamless travel experiences that leave a lasting, positive impact.”
                ...
                <img src="/assets/images/about/large/img1.png" alt="" className="size-full min-h-75 object-cover" data-speed="0.7" />
            </div>
        </div>
    </section>
  );
