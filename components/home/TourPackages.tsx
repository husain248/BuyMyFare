    ...
    <section className="lg:pt-40 lg:pb-45 sm:py-25 py-18 overflow-hidden">
        <div className="container-left relative z-1">
            <div className="lg:mb-10 sm:mb-5 mb-2.5">
                <span className="text-white font-main" style={{ textTransform: 'capitalize', fontSize: '32px', color: '#072032' }}>Discover Your Next Adventure</span>
                <h2 className="2xxl:text-10xl lg:text-8xl md:text-5xxl sm:text-4xl text-3xxl uppercase font-medium headline">Perfect Holiday</h2>
            </div>
            <div className="row">
                <div className="lg:w-[27%] w-full">
                    <div className="mb-10 relative after:absolute after:top-full after:right-[20%] after:w-px xl:after:h-100 after:h-60 after:bg-black/50 max-lg:after:hidden">
                        <p className="xl:text-xl sm:text-lg text-sm font-normal lg:mb-10 sm:mb-5 mb-2.5">Exciting  Explore our curated travel packages for every kind of traveler. Whether it’s a relaxing escape or an action-packed journey, we make it unforgettable. </p>
                                ...
                                <div className="swiper-slide" key={idx}>
                                    <div className="relative tour-card">
                                        <div className="relative overflow-hidden rounded-xxl before:absolute before:inset-0 before:bg-linear-to-b before:from-transparent before:to-black/60">
                                            <img src={`/assets/images/tour/style1/${tour.img}`} alt={tour.title} className="size-full object-cover" />
                                        </div>
                                        <div className="absolute left-0 bottom-0 sm:p-7.5 p-4.5 flex items-center justify-between w-full">
                                            ...
                                            <div className="text-right">
                                                ...
                                                <span className="block font-title text-2xxl text-primary font-semibold">$199</span>
                                            </div>
                                        </div>
                                        <Link href="/trip-details" className="view-detail"> View<br/>Details </Link>
                                    </div>
                                </div>
                            ))}
                        </div>
