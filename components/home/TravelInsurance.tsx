...
export default function TravelInsurance() {
  return (
    <section id="nextSection" className="relative md:py-20 py-15 before:absolute before:top-0 before:right-[21%] before:bg-[#EEEEEE] before:w-[22.35%] before:h-full before:-z-1 max-lg:before:hidden after:absolute after:-bottom-47.5 lg:after:-left-72.5 after:left-0 after:size-full after:bg-no-repeat after:bg-bottom-left after:bg-[url(/assets/images/background/bg1.png)] after:-z-1">
        <div className="container">
            <div className="row">
                <div className="lg:w-1/2 w-full">
                    <div className="lg:pt-20 relative mb-10">
                        <div className="sm:mb-10 mb-5">
                            <span className="block lg:text-3xl sm:text-2xl text-xl leading-none font-semibold font-title text-primary capitalize mb-2.5 font-main">Peace of Mind for Your Travels </span>
                            <h2 className="2xxl:text-10xl lg:text-8xl md:text-5xxl sm:text-4xl text-3xxl uppercase max-w-100">Travel Insurance</h2>
                            <p className="mt-5"> Ensure your trip is stress-free with our comprehensive travel insurance, covering medical emergencies, trip cancellations, lost luggage, and more. We also offer Super Visa Insurance for those visiting family in Canada, which is essential for meeting Canada’s immigration requirements. </p>
                        </div>
                        <div className="sm:mb-10 mb-7.5">
                            <ul className="flex flex-wrap text-secondary grid-2 font-medium mb-7.5">
                                <li className="w-1/2 relative p-1.25 ps-9.5 xl:text-xl text-sm font-medium before:absolute before:left-0 before:bg-no-repeat before:size-7 before:bg-check before:top-1"> 24/7 Support
                                    <p className="text-sm"> Always here when you need assistance. </p>
                                    </li>
                                <li className="w-1/2 relative p-1.25 ps-9.5 xl:text-xl text-sm font-medium before:absolute before:left-0 before:bg-no-repeat before:size-7 before:bg-check before:top-1"> Tailored Solutions 
                                    <p className="text-sm">  We customize coverage to fit your travel needs. </p>
                                </li>
                            </ul>
                        </div>
                        <div className="bg-[#F2EFEA] relative overflow-hidden rounded-2xl flex flex-wrap items-center p-5">
                            <div className="text-center relative">
                                <h3 className="xl:text-3xl sm:text-2xxl text-2xl font-medium mb-2.5 uppercase">Super Visa Insurance </h3>
                                <span className="block font-title font-normal text-lg capitalize mb-5">Required by Canadian immigration, our Super Visa Insurance ensures you meet coverage standards, keeping you protected throughout your stay.</span>
                                <div className="mb-5"><strong> Don’t risk your journey—get insured today! </strong></div>
                            </div>
                                ...
                                <div className="flex flex-wrap items-center gap-7.5 justify-center">
                                    ...
                                    <div className="inline-flex items-center gap-3.75">
                                        ...
                                        <div className="widget-content">
                                            <a href="tel:+11234567890" className="sm:text-2xl text-base font-title font-semibold text-secondary">+1 780 600 1550</a>
                    ...
                    <div className="relative max-2xl:flex max-2xl:flex-col max-2xl:gap-5">
                        <div className="flex items-center justify-start wow fadeInDown" data-wow-delay="1s">
                            <div className="-rotate-6 bg-white p-2.5 shadow-1">
                                <img src="/assets/images/about/img1.png" alt="" className="w-full" />
                            </div>
                        </div>
                        <div className="flex items-center justify-end -mt-12.5 wow fadeInRight" data-wow-delay="1s">
                            <div className="rotate-2 bg-white p-2.5 shadow-1">
                                <img src="/assets/images/about/img2.png" alt="" className="w-full" />
                            </div>
                        </div>
                        <div className="flex items-center justify-start -mt-12.5 relative">
                            <div className="rotate-6 bg-white p-2.5 shadow-1">
                                <img src="/assets/images/about/img3.png" alt="" className="w-full wow fadeInUp" data-wow-delay="1s" />
                            </div>
                        </div>
                    </div>
                </div>
